...
// architect-v2 QUARANTINED in v10.6.0 "Renata": v1 hybrid (architect-llm.ts +
...
// the activation graph. Do NOT re-import it without a new ADR.
// import { ArchitectV2Panel } from "./architect-v2/host/index.js";
...
export function activate(context: vscode.ExtensionContext): void {
  ...
  const commands: [string, (...args: unknown[]) => unknown][] = [
    ...
    ["dreamgraph.openExplorer", () => openExplorerCommand(services)],
    ["dreamgraph.toggleGpuMetrics", () => toggleGpuMetricsCommand()],
  ...
  // ---- architect-v2 QUARANTINED (v10.6.0 "Renata") ----
