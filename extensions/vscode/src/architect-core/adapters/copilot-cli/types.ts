 ...
 */
export const COPILOT_CLI_PROVIDER_ID = "copilot-cli" as const;
...
export type CopilotCliErrorCode =
  ...
  | "COPILOT_CLI_VERSION_UNSUPPORTED"
  ...
  | "PERMISSION_ARG_POLICY_UNSUPPORTED"
  | "TIMEOUT"
  ...
  | "CANCELLED"
  | "COPILOT_RUN_NONZERO_EXIT"
  | "COPILOT_RUN_SIGNALED";
 ...
 * `DREAMGRAPH_TOOL_REGISTRY_MISMATCH`.
 */
export const COPILOT_MINIMUM_AUTHORITATIVE_TOOLS = Object.freeze([
  "query_resource",
  "query_api_surface",
  "read_source_code",
  "search_source_code",
 ...
 */
export const COPILOT_BRIDGE_LOCAL_AUTHORITATIVE_TOOLS = Object.freeze([
  "run_command",
] as const);
 ...
 */
export const COPILOT_NATIVE_COMMAND_TOOLS = Object.freeze([] as const);
 ...
 */
export const COPILOT_AUTHORITATIVE_TOOL_CATALOG = Object.freeze([
 ...
 */
export const COPILOT_REQUIRED_AUTHORITATIVE_TOOLS =
  COPILOT_MINIMUM_AUTHORITATIVE_TOOLS;

export type CopilotAuthoritativeToolName =
  (typeof COPILOT_AUTHORITATIVE_TOOL_CATALOG)[number];
 ...
 */
export const COPILOT_INLINE_TOOL_SERVER = "<inline>" as const;
