...
* **Model Agnostic:** Hot-swap providers or local models on the fly. The context stays in the Graph, not the session.
* **Graph-Grounded Reasoning:** Surgical context selection. We ship the 2.4kB that matters, not the 800kB that costs.
...
## Status: v13.2.0 "Continuation Boundaries"
