...
// ---------------------------------------------------------------------------
// Canonical tool definition + tool call
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Non-streaming response (used by callWithTools)
// ---------------------------------------------------------------------------
 ...
 */
export class ProviderAdapterNotImplementedError extends ProviderError {
...
export function createStubAdapter(
  ...
  return {
    ...
    async callWithTools(): Promise<ChatResponse> {
      throw new ProviderAdapterNotImplementedError(providerId, model.id, slice);
    },
  };
}
