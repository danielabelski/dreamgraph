...
} from "../../../context/discovery-recorder.js";
...
export class DreamGraphRecorderAdapter
  implements ProjectGraphRecorder, ContextDiscoveryRecorder
{
  ...
  async recordCards(cards: readonly ArchitectCard[]): Promise<void> {
  ...
  async recordContinuation(continuation: ContinuationNeed): Promise<void> {
    await this.safeCall("mcp_dreamgraph_solidify_cognitive_insight", {
  ...
  async recordDiscoveries(
    discoveries: readonly ContextDiscovery[],
  ): Promise<void> {
