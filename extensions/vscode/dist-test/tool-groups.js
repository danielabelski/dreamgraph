...
exports.MAX_TOOLS_AUTONOMY = exports.MAX_TOOLS_MUTATION = exports.MAX_TOOLS_DEFAULT = exports.TOOL_GROUPS = void 0;
exports.selectToolGroups = selectToolGroups;
/* ------------------------------------------------------------------ */
...
/*  Hard caps                                                         */
/* ------------------------------------------------------------------ */
exports.MAX_TOOLS_DEFAULT = 12;
exports.MAX_TOOLS_MUTATION = 18;
exports.MAX_TOOLS_AUTONOMY = 24;
/* ------------------------------------------------------------------ */
...
const GRAPH_WRITE_KEYWORDS = [
    ...
    'graph write tool',
    'graph mutation tool',
    'graph write/mutation',
    'graph write/mutation tool',
    'mutation/write tool',
    'write/mutation tool',
    'expose graph mutation',
    'expose graph write',
    'enable graph mutation',
    'enable graph write',
    'apply edges',
    'apply graph edges',
    'apply prepared edges',
    'apply prepared source-domain edges',
    'source-domain edges',
    'source domain edges',
    'feature edges',
    'prepared source-domain feature edges',
    'prepared source domain feature edges',
    'persist edges',
    'persist graph edges',
    'enrich_seed_data',
...
function _hasAny(prompt, keywords) {
 ...
 */
function selectToolGroups(args) {
    ...
    for (const g of uniqueGroups) {
        for (const name of exports.TOOL_GROUPS[g]) {
            if (!seen.has(name)) {
                seen.add(name);
    ...
    if (primedTools && primedTools.length > 0) {
        ...
        for (const [groupKey, list] of Object.entries(exports.TOOL_GROUPS)) {
    ...
    // Apply cap.
    const cap = autonomy ? exports.MAX_TOOLS_AUTONOMY : mutating ? exports.MAX_TOOLS_MUTATION : exports.MAX_TOOLS_DEFAULT;
    ...
    for (const list of Object.values(exports.TOOL_GROUPS)) {
