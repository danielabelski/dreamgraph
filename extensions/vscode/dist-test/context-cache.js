...
class ContextCache {
     ...
     */
    static MCP_CONTEXT_FETCH_TIMEOUT_MS = (() => {
    ...
    static ENV_SNAPSHOT_TTL_MS = 5 * 60_000;
    /** Dream/causal/temporal/cognitive change on dream-cycle cadence. */
    static DEEP_INSIGHTS_TTL_MS = 30_000;
    /**
     ...
     */
    static COGNITIVE_MUTATING_TOOLS = new Set([
        "dream_cycle",
        "nightmare_cycle",
        "normalize_dreams",
        "resolve_tension",
    ...
    setEnvSnapshot(workspaceRoot, snapshot) {
        this._envSnapshot = {
            workspaceRoot,
            snapshot,
