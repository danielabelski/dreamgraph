...
exports.getLlmTimeoutMs = getLlmTimeoutMs;
exports.isTimeoutError = isTimeoutError;
exports.buildTimeoutRecoveryPrompt = buildTimeoutRecoveryPrompt;
...
exports.REQUEST_TIMEOUT_MS = 90_000;
 ...
 */
function getLlmTimeoutMs(options) {
    const provider = options.provider ?? 'anthropic';
    const selected = PROVIDER_BUDGETS[provider] ?? { stream: exports.REQUEST_TIMEOUT_MS, tool: exports.REQUEST_TIMEOUT_MS };
 ...
 */
function buildTimeoutRecoveryPrompt(originalText) {
    return [
        originalText,
        '',
 ...
 */
function createTimeoutAbortSignal(parent, timeoutMs = exports.REQUEST_TIMEOUT_MS) {
