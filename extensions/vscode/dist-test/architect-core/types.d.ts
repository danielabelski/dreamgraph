import type { ArchitectContent, ArchitectMessage, ArchitectProvider, ArchitectToolResponse, ToolDefinition, ToolUseRequest } from "../architect-llm.js";
 ...
 */
export type PassStopReason = "complete" | "max-iterations" | "aborted" | "error";
/**
...
export type { ArchitectContent, ArchitectMessage, ArchitectProvider, ArchitectTask, ArchitectToolResponse, EditorContextEnvelope, ReasoningPacket, ToolDefinition, ToolUseRequest, };
