...
exports.parseCopilotHelpSurface = parseCopilotHelpSurface;
 ...
 */
function promptFlagPresent(help) {
    return (flagPresent(help, "--prompt") ||
        /(^|\s)-p(\s|,)/m.test(help));
}
/**
 ...
 */
function parseCopilotHelpSurface(helpText, versionString = null) {
