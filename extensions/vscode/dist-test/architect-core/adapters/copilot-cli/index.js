...
exports.createCopilotCliProviderPort = exports.serializeConversationForCopilotCli = exports.probeDreamgraphStdio = exports.createHostRegistry = exports.createHostAudit = exports.bridgeEnvForRun = exports.auditFilePathFor = exports.HOST_PROCESS = exports.HOST_FS = exports.HOST_CRYPTO = exports.HOST_CLOCK = exports.runCopilotCli = exports.normalizeCopilotTranscript = exports.classifyToolCall = exports.buildCopilotArgv = exports.buildAuthoritativeAllowlist = exports.serializeCopilotMcpConfig = exports.buildCopilotMcpConfig = exports.parseCopilotHelpSurface = exports.isHelpSurfaceSupported = exports.DREAMGRAPH_AUTHORITATIVE_SERVER_NAME = exports.COPILOT_REQUIRED_AUTHORITATIVE_TOOLS = exports.COPILOT_INLINE_TOOL_SERVER = exports.COPILOT_CLI_PROVIDER_ID = void 0;
...
Object.defineProperty(exports, "probeDreamgraphStdio", { enumerable: true, get: function () { return index_js_1.probeDreamgraphStdio; } });
