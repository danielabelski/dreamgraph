...
exports.detectArchitectLens = detectArchitectLens;
exports.lensLabel = lensLabel;
const LENS_RULES = [
    {
        lens: "performance",
        keywords: [
 ...
 */
function scoreRule(rule, prompt, commandSource) {
    const matched = [];
    ...
    if (matched.length === 0 && !commandMatch)
        return null;
 ...
 */
function detectArchitectLens(input) {
    ...
    const explanatoryDowngrade = input.intentMode === "ask_dreamgraph" &&
...
//# sourceMappingURL=architect-lens.js.map