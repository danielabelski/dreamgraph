 ...
 */
export declare function shouldFetchDeepInsight(kind: ContextEvidenceKind, requiredEvidence: ReadonlySet<ContextEvidenceKind>, pressureLabel: 'low' | 'normal' | 'high'): boolean;
//# sourceMappingURL=budget-coordinator-reader.d.ts.map