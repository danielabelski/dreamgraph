...
exports.EMPTY_DENSITY_PROBE = void 0;
exports.measureDensity = measureDensity;
/** Empty probe — the day-zero install state. Drives sparse-mode everywhere. */
exports.EMPTY_DENSITY_PROBE = Object.freeze({
    hasIndex: false,
    sourceEntityCount: 0,
    apiEntityCount: 0,
    adrCount: 0,
 ...
 */
function measureDensity(probe, capabilityId) {
    if (!probe.hasIndex)
        return "absent";
    switch (capabilityId) {
        // --- Navigation & search ---
        ...
        case "search.semantic":
            return bucketByCount(probe.apiEntityCount + probe.recentDreamInsightCount + probe.adrCount);
        ...
        case "memory.recall":
            return bucketByCount(probe.recentDreamInsightCount + probe.resolvedTensionCount);
        // --- Mutation ---
