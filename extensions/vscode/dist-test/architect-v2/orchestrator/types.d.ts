...
import type { ActionCandidate, ContinuationNeed, TaskState } from "../autonomy/index.js";
import type { ToolOutcome } from "../execution/index.js";
import type { CompletionMetrics, CompletionStatus } from "../verification/index.js";
/**
...
export interface UnmetRequirement {
    readonly requirementKind: string;
    readonly reason: "no_signal_source" | "graph_absent" | "fallback_empty" | "budget_dropped" | "source_error";
