 ...
 */
export type WebviewDiagnosticScope = "render-unknown" | "render-empty" | "render-error";
/**
 * Messages the extension host sends TO the webview.
 */
export type HostToWebview = {
    kind: "init";
    state: PanelInitState;
} | {
    kind: "status";
    status: PanelStatus;
    detail?: string;
...
export type AutonomyModeId = "cautious" | "conscientious" | "eager" | "autonomous";
export type PanelStatus = "idle" | "running" | "waiting-for-user" | "error";
...
export type RenderedChunkKind = "goal" | "plan" | "context" | "decision" | "edit" | "verification" | "blocker" | "next-step" | "completion" | "fallback" | "outcome" | "note";
/**
