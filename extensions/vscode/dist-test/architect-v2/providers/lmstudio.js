...
exports.lmstudioProfile = void 0;
const lmstudio_adapter_1 = require("./transports/lmstudio-adapter");
const LMSTUDIO_DEFAULT_MODEL = {
    id: "gpt-oss-120b",
...
exports.lmstudioProfile = {
    ...
    async listModels() {
        ...
        // always resolves.
        return (0, lmstudio_adapter_1.discoverLmStudioModels)({ baseUrl: lmstudio_adapter_1.LMSTUDIO_DEFAULT_BASE_URL }, [LMSTUDIO_DEFAULT_MODEL], {
    ...
    createAdapter(model, config) {
        return new lmstudio_adapter_1.LMStudioAdapter(model, config);
    },
};
