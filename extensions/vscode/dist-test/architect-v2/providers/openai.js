...
exports.openaiProfile = void 0;
const openai_chat_adapter_1 = require("./transports/openai-chat-adapter");
const openai_responses_adapter_1 = require("./transports/openai-responses-adapter");
const OPENAI_MODELS = [
    {
        id: "gpt-5.5",
        ...
        capabilities: {
            ...
            notes: "Responses API: stores reasoning state server-side; encrypted_content " +
    ...
    },
    {
        ...
        capabilities: {
            ...
            notes: "Equal-class #2 default per ADR-150. Standard Chat Completions tool " +
                "envelope; no reasoning round-trip.",
        },
    },
];
exports.openaiProfile = {
    id: "openai",
    displayName: "OpenAI",
    modelSource: "static",
    ...
    createAdapter(model, config) {
        ...
        if (model.capabilities.api === "openai-responses") {
            return new openai_responses_adapter_1.OpenAIResponsesAdapter(model, config);
        }
        return new openai_chat_adapter_1.OpenAIChatAdapter(model, config);
    },
};
