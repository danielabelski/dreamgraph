...
exports.isArchitectPassEnvelope = exports.ARCHITECT_PASS_SCHEMA_NAME = exports.StrictNarrativeStreamExtractor = void 0;
exports.projectStrictEnvelopeToLegacy = projectStrictEnvelopeToLegacy;
const architect_pass_schema_js_1 = require("./architect-pass-schema.js");
Object.defineProperty(exports, "ARCHITECT_PASS_SCHEMA_NAME", { enumerable: true, get: function () { return architect_pass_schema_js_1.ARCHITECT_PASS_SCHEMA_NAME; } });
Object.defineProperty(exports, "isArchitectPassEnvelope", { enumerable: true, get: function () { return architect_pass_schema_js_1.isArchitectPassEnvelope; } });
/**
 ...
 * to legacy behaviour).
 */
function projectStrictEnvelopeToLegacy(rawContent) {
    const strict = (0, architect_pass_schema_js_1.tryParseArchitectPassEnvelope)(rawContent);
    if (!strict)
        return null;
 ...
 */
class StrictNarrativeStreamExtractor {
    rawBuf = '';
    decisionMade = false;
    isStrict = false;
...
exports.StrictNarrativeStreamExtractor = StrictNarrativeStreamExtractor;
/**
 ...
 */
function decodeJsonStringChunk(buf) {
    let out = '';
    let i = 0;
    const n = buf.length;
    while (i < n) {
...
//# sourceMappingURL=architect-pass-projection.js.map