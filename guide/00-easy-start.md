...
You should see DreamGraph CLI v13.0.0 or newer.
...
Continue with [Installation](02-installation.md), [Your first instance](03-first-instance.md), [LLM setup](04-llm-setup.md), or [Architect](15-architect-beta.md) only when you need more detail.
